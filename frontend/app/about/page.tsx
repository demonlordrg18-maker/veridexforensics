...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-obsidian text-slate-300 font-sans selection:bg-amber-signal/20 selection:text-amber-signal scanline-overlay">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 border border-amber-signal/30 bg-amber-signal/5 px-4 py-1.5 text-[9px] font-mono font-bold text-amber-signal uppercase tracking-[0.3em] rounded-none">
              // CORE MISSION: DIGITAL TRUST ASSURANCES
            </div>
      ...
      <section className="py-24 px-6 md:px-12 bg-obsidian">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
           <div className="space-y-6">
              ...
              <h3 className="text-3xl font-black text-white leading-tight uppercase">The Erosion of Public Verification.</h3>
              ...
              <div className="pt-2 font-mono text-[9px]">
                <Link href="/reports" className="font-bold text-amber-signal uppercase tracking-widest hover:underline">
                  [ Explore Signed Evidence Reports ]
                </Link>
              </div>
           </div>
           <div className="grid grid-cols-2 gap-6 font-mono text-[11px]">
              <div className="border border-deepslate bg-[#030712] p-8 rounded-none space-y-4 relative">
                 ...
                 <h4 className="font-bold text-white uppercase text-xs">// Targeted Focus</h4>
              ...
              <div className="border border-deepslate bg-[#030712] p-8 rounded-none space-y-4 relative">
                 ...
                 <h4 className="font-bold text-white uppercase text-xs">// Ledger-First</h4>
              ...
              <div className="border border-deepslate bg-[#030712] p-8 rounded-none space-y-4 relative">
                 ...
                 <h4 className="font-bold text-white uppercase text-xs">// Assistive</h4>
              ...
              <div className="border border-deepslate bg-[#030712] p-8 rounded-none space-y-4 relative">
                 ...
                 <h4 className="font-bold text-white uppercase text-xs">// Global Scale</h4>
      ...
      {/* Philosophy Section */}
      <section className="py-24 px-6 md:px-12 bg-[#02050b] border-t border-deepslate scanner-grid">
        <div className="max-w-4xl mx-auto text-center relative z-10 space-y-12">
           <h2 className="text-[10px] font-mono font-bold text-amber-signal uppercase tracking-[0.4em] mb-12">// Our Verification Heuristics</h2>
           <h3 className="text-3xl md:text-4xl font-black text-white uppercase">Probabilistic signals for high-trust workflows.</h3>
           <div className="space-y-12 text-left">
              <div className="pb-12 border-b border-slate-900">
                 <h4 className="text-lg font-bold text-white uppercase tracking-wide">// 01. Integrity-First Infrastructure</h4>
              ...
              <div className="pb-12 border-b border-slate-900">
                 <h4 className="text-lg font-bold text-white uppercase tracking-wide">// 02. Algorithmically Honest</h4>
                 <p className="text-slate-400 leading-relaxed text-sm font-sans text-justify mt-2">
                   We are honest about our boundaries. Forensic detection is a cat-and-mouse game. We don't promise 100% detection; we promise 100% transparency into the signals we use, the logic we follow, and the limitations of our heuristics.
                 </p>
              </div>
              <div>
                 <h4 className="text-lg font-bold text-white uppercase tracking-wide">// 03. Augmenting the Expert</h4>
                 <p className="text-slate-400 leading-relaxed text-sm font-sans text-justify mt-2">
