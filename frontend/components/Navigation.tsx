  ...
  return (
    <nav className="flex items-center justify-between py-6 px-4 md:px-12 glass-dark fixed top-0 w-full z-50 border-b border-white/5">
      ...
      <div className="hidden lg:flex items-center gap-8 text-sm font-medium text-slate-400">
        ...
        <Link href="/pricing" className="hover:text-teal-400 transition-colors font-bold text-teal-400/95">Pricing</Link>
    ...
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
      ...
      <div>
        ...
        <ul className="space-y-4 text-sm text-slate-500">
          ...
          <li><Link href="/pricing" className="hover:text-teal-400 transition-colors font-bold text-teal-400/90">Plans & Pricing</Link></li>
